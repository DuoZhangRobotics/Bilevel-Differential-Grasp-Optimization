...
scalar ComputeWeightInterface::fractionTet(const scalar& v0,const scalar& v1,const scalar& v2,const scalar& v3,unsigned char tag)
{
  ...
  case 0:
    return 0.0f;
  case 1:
    return -v0*v0*v0/std::max((v1-v0)*(v2-v0)*(v3-v0),ScalarUtil<scalar>::scalar_eps());
  case 2:
    return -v1*v1*v1/std::max((v0-v1)*(v2-v1)*(v3-v1),ScalarUtil<scalar>::scalar_eps());
  case 3:
    return v1*v1/std::max((v2-v1)*(v3-v1),ScalarUtil<scalar>::scalar_eps())+
           v0*v2*v1/std::max((v2-v0)*(v2-v1)*(v3-v1),ScalarUtil<scalar>::scalar_eps())+
           v0*v0*v3/std::max((v3-v0)*(v2-v0)*(v3-v1),ScalarUtil<scalar>::scalar_eps());
  case 4:
    return -v2*v2*v2/std::max((v0-v2)*(v1-v2)*(v3-v2),ScalarUtil<scalar>::scalar_eps());
  case 5:
    return v2*v2/std::max((v3-v2)*(v1-v2),ScalarUtil<scalar>::scalar_eps())+
           v0*v3*v2/std::max((v3-v0)*(v3-v2)*(v1-v2),ScalarUtil<scalar>::scalar_eps())+
           v0*v0*v1/std::max((v1-v0)*(v3-v0)*(v1-v2),ScalarUtil<scalar>::scalar_eps());
  case 6:
    return v1*v1/std::max((v3-v1)*(v0-v1),ScalarUtil<scalar>::scalar_eps())+
           v2*v3*v1/std::max((v3-v2)*(v3-v1)*(v0-v1),ScalarUtil<scalar>::scalar_eps())+
           v2*v2*v0/std::max((v0-v2)*(v3-v2)*(v0-v1),ScalarUtil<scalar>::scalar_eps());
  case 8:
    return -v3*v3*v3/std::max((v0-v3)*(v1-v3)*(v2-v3),ScalarUtil<scalar>::scalar_eps());
  case 15:
    return 1.0f;
  }
...
scalar ComputeWeightInterface::fractionCell2DBF(const scalar& v0,const scalar& v1,const scalar& v2,const scalar& v3)
{
  ...
  INFOV("Sum: %f",std::convert<double>()(sum))
  switch(tag) {
  case 0:
    return 0.0f;
  case 1:
...
void ComputeWeightInterface::debugFractionTet()
{
  ...
  for(sizeType i=0; i<16; i++) {
    ...
    INFOV("\tBruteForce: %f,%f,%f,%f",
          std::convert<double>()(fracFBA),
          std::convert<double>()(fracFBB),
          std::convert<double>()(fracFBC),
          std::convert<double>()(fracFBD))
    INFOV("\tFastCalcul: %f,%f,%f,%f",
          std::convert<double>()(fracA),
          std::convert<double>()(fracB),
          std::convert<double>()(fracC),
          std::convert<double>()(fracD))

    ASSERT(std::abs(fracFBA-fracFBB) < ScalarUtil<scalar>::scalar_eps())
    ASSERT(std::abs(fracFBA-fracFBC) < ScalarUtil<scalar>::scalar_eps())
    ASSERT(std::abs(fracFBA-fracFBD) < ScalarUtil<scalar>::scalar_eps())

    ASSERT(std::abs(fracFBA-fracA) < ScalarUtil<scalar>::scalar_eps())
    ASSERT(std::abs(fracFBA-fracB) < ScalarUtil<scalar>::scalar_eps())
    ASSERT(std::abs(fracFBA-fracD) < ScalarUtil<scalar>::scalar_eps())
    ASSERT(std::abs(fracFBA-fracC) < ScalarUtil<scalar>::scalar_eps())
  }
}
void ComputeWeightInterface::debugFractionCell2D()
{
  ...
  for(sizeType i=0; i<16; i++) {
    ...
    INFOV("Fraction Cell 2D: %f %f",std::convert<double>()(fracA),std::convert<double>()(fracB))
    ASSERT(std::abs(fracA-fracB) < ScalarUtil<scalar>::scalar_eps())
  }
}
void ComputeWeightInterface::debugFractionCell3D()
{
  ...
  INFOV("FractionCell3DFastCalcul: %f",std::convert<double>()(fractionCell3D(2.0f,2.0f,-2.0f,-2.0f,6.0f,6.0f, 2.0f, 2.0f)))
  INFOV("FractionCell3DBruteForce: %f",std::convert<double>()(fractionCell3DBF(2.0f,2.0f,-2.0f,-2.0f,6.0f,6.0f, 2.0f, 2.0f, v0,v1,v2,v3,v4,v5,v6,v7)))
}
