...
template <typename T,int O,typename I>
typename Eigen::SparseMatrix<T,O,I> buildKKT(const Eigen::SparseMatrix<T,O,I>& h,const Eigen::SparseMatrix<T,O,I>& a,T shift)
{
...
Eigen::SparseMatrix<T,O,I> toSparse(const MT& m)
{
  Eigen::SparseMatrix<T,O,I> ret;
  ParallelVector<Eigen::Triplet<T,I>> trips;
