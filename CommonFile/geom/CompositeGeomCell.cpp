...
CompositeGeomCell::CompositeGeomCell(const CompositeGeomCell& other):StaticGeomCell(typeid(CompositeGeomCell).name())
{
  _children.clear();
...
CompositeGeomCell::CompositeGeomCell(const Mat4& T,std::vector<std::shared_ptr<StaticGeomCell> > children)
