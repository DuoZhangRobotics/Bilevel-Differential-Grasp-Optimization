...
//TwoSphereMeshCell
TwoSphereMeshCell::TwoSphereMeshCell()
{
  setType(typeid(TwoSphereMeshCell).name());
}
TwoSphereMeshCell::TwoSphereMeshCell(sizeType dim,const Vec3& ctr1,const Vec3& ctr2,scalar rad1,scalar rad2)
...
BBox<scalar> TwoSphereMeshCell::getBBInner() const
{
...
//ThreeSphereMeshCell
ThreeSphereMeshCell::ThreeSphereMeshCell()
{
  setType(typeid(ThreeSphereMeshCell).name());
}
ThreeSphereMeshCell::ThreeSphereMeshCell(sizeType dim,const Vec3& ctr1,const Vec3& ctr2,const Vec3 ctr3,scalar rad1,scalar rad2,scalar rad3)
...
BBox<scalar> ThreeSphereMeshCell::getBBInner() const
{
  BBox<scalar> bb;
