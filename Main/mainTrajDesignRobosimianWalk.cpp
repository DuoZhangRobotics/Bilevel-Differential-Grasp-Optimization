...
void trajDesignRobosimian(const std::string& path,sizeType step=2,T dt=0.5f,Vec3T dir=Vec3T(0.4f,0,0),Vec3T dirZ=Vec3T(0,0,0.3f),bool swap=true)
{
...
int main()
{
  ...
  create("Robosimian");
  RandEngine::seed(0);
  trajDesignRobosimian("Robosimian/RobosimianWalk",10);
  trajDesignRobosimian("Robosimian/RobosimianWalkFast",20,0.25f);
  return 0;
}
