...
void trajDesignSpider(const std::string& path,sizeType step=2,T dt=1.0f,Vec3T dir=Vec3T(0.4f,0,0),Vec3T dirZ=Vec3T(0,0,0.3f),bool swap=true)
{
...
int main()
{
  ...
  create("Spider");
  RandEngine::seed(0);
  trajDesignSpider("Spider/SpiderWalk",10);
  trajDesignSpider("Spider/SpiderWalkFast",20,1.0f,Vec3T(0.6f,0,0));
  return 0;
}
